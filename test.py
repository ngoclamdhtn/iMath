...
# test, test_latex="",""
# for i in range(3):
# 	debai_word,debai_latex,loigiai_word,phuongan,latex_tuluan,loigiai_traloingan,dap_an=D10_C10.gghik_L10_CX_B0_57()
...
test, test_latex="",""
for i in range(1):
	debai,debai_latex,loigiai_word,dap_an = D10_C7.aaa_pry_L10_C7_B2_20()
	#print(debai)
	#print(loigiai_word)
	test=test + f"{debai}\n{loigiai_word}\n"
	test_latex=test_latex + f"{debai_latex}\n"
...
# test, test_latex="",""
# for i in range(1):
# 	debai_word,loigiai_word,latex_tuluan,dap_an =D10_C7.aaa_pry_L10_C7_B2_20()
# 	#print(debai)\\log {d}
# 	#print(loigiai_word)
# 	test=test + f"{debai_word}\n{loigiai_word}\n"
