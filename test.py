...
# test, test_latex="",""
# for i in range(3):
# 	debai_word,debai_latex,loigiai_word,phuongan,latex_tuluan,loigiai_traloingan,dap_an=D11_C6.npl_mk_L10_C3_B2_16()
...
# test, test_latex="",""
# for i in range(1):
# 	debai,debai_latex,loigiai_word,dap_an = D12_C5.htd_25_xyz_L12_C5_B3_11()
# 	#print(debai)
# 	#print(loigiai_word)
# 	test=test + f"{debai}\n{loigiai_word}\n"
# 	test_latex=test_latex + f"{debai_latex}\n"
...
test, test_latex="",""
for i in range(1):
	debai_word,loigiai_word,latex_tuluan,dap_an =D10_C3.npl_mk_L10_C3_B2_28()
	#print(debai)\\log {d}
	#print(loigiai_word)
	test=test + f"{debai_word}\n{loigiai_word}\n"
