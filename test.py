...
# test, test_latex="",""
# for i in range(1):
# 	debai_word,debai_latex,loigiai_word,phuongan,latex_tuluan,loigiai_traloingan,dap_an=D12_C6.newy25_L12_C6_B2_25()
...
test, test_latex="",""
for i in range(50):
	debai,debai_latex,loigiai_word,dap_an =D12_C6.newy25_L12_C6_B1_21()
	#print(debai)
	#print(loigiai_word)
	test=test + f"{debai}\n{loigiai_word}\n"
	test_latex=test_latex + f"{debai_latex}\n"
