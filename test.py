...
# test, test_latex="",""
# for i in range(1):
# 	debai_word,debai_latex,loigiai_word,phuongan,latex_tuluan,loigiai_traloingan,dap_an=D10_C7.aaa_pry_L10_C7_B1_18()
...
# test, test_latex="",""
# for i in range(1):
# 	debai,debai_latex,loigiai_word,dap_an = D10_C8.mcn__L10_C8_B2_56()
# 	#print(debai)
# 	#print(loigiai_word)
# 	test=test + f"{debai}\n{loigiai_word}\n"
# 	test_latex=test_latex + f"{debai_latex}\n"
