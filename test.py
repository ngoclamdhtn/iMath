...
# test, test_latex="",""
# for i in range(1):
# 	debai_word,debai_latex,loigiai_word,phuongan,latex_tuluan,loigiai_traloingan,dap_an=D12_C2.mnj_34_jkl_L12_C2_B3_22()
...
test, test_latex="",""
for i in range(1):
	debai,debai_latex,loigiai_word,dap_an =D11_C3.gh11gh_L11_C3_B1_10()
	#print(debai)
	#print(loigiai_word)
	test=test + f"{debai}\n{loigiai_word}\n"
	test_latex=test_latex + f"{debai_latex}\n"
