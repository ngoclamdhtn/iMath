...
# test, test_latex="",""
# for i in range(5):
# 	debai_word,debai_latex,loigiai_word,phuongan,latex_tuluan,loigiai_traloingan,dap_an=D11_C4.ghj_7_jkl_L11_C4_B5_05()
...
test, test_latex="",""
for i in range(1):
	debai,debai_latex,loigiai_word,dap_an = D10_C5.y7y7u_L10_C5_B4_11()
	#print(debai)
	#print(loigiai_word)
	test=test + f"{debai}\n{loigiai_word}\n"
	test_latex=test_latex + f"{debai_latex}\n"
