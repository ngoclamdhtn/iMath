...
# test, test_latex="",""
# for i in range(1):
# 	debai_word,debai_latex,loigiai_word,phuongan,latex_tuluan,loigiai_traloingan,dap_an=D12_C4.ckz_L12C4_B5_21()
...
# test, test_latex="",""
# for i in range(1):
# 	debai,debai_latex,loigiai_word,dap_an =D11_C6.uz9zu_L11_C6_B2_18()
# 	#print(debai)
# 	#print(loigiai_word)
# 	test=test + f"{debai}\n{loigiai_word}\n"
# 	test_latex=test_latex + f"{debai_latex}\n"
