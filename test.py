...
# test, test_latex="",""
# for i in range(3):
# 	debai_word,debai_latex,loigiai_word,phuongan,latex_tuluan,loigiai_traloingan,dap_an=D12_C4.ckz_L12C4_B4_31()
...
test, test_latex="",""
for i in range(3):
	debai,debai_latex,loigiai_word,dap_an =D12_C4.ckz_L12C4_B4_37()
	#print(debai)
	#print(loigiai_word)
	test=test + f"{debai}\n{loigiai_word}\n"
	test_latex=test_latex + f"{debai_latex}\n"
...
# test, test_latex="",""
# for i in range(1):
# 	debai_word,loigiai_word,latex_tuluan,dap_an = D12_C4.ckz_L12C4_B4_23()
# 	#print(debai)
# 	#print(loigiai_word)
# 	test=test + f"{debai_word}\n{loigiai_word}\n"
