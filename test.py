...
test, test_latex="",""
for i in range(1):
	debai_word,debai_latex,loigiai_word,phuongan,latex_tuluan,loigiai_traloingan,dap_an=D10_C2.bch_12_L10_C2_B2_27()
...
# test, test_latex="",""
# for i in range(1):
# 	debai,debai_latex,loigiai_word,dap_an = D12_C1.prt_34_L12_C1_B5_05()
# 	#print(debai)
# 	#print(loigiai_word)
# 	test=test + f"{debai}\n{loigiai_word}\n"
# 	test_latex=test_latex + f"{debai_latex}\n"
...
# test, test_latex="",""
# for i in range(100):
# 	debai_word,loigiai_word,latex_tuluan,dap_an = D10_C2.bch_12_L10_C2_B2_27()
# 	#print(debai)\\log {d}
# 	#print(loigiai_word)
# 	test=test + f"{debai_word}\n{loigiai_word}\n"
