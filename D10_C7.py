...
def aaa_pry_L10_C7_B2_14():
    ...
    noi_dung=random.choice([
        f"Tìm số giá trị nguyên của tham số ${{m}}$ thuộc khoảng $({t_1};{t_2})$ để bất phương trình ${f}>0$ nghiệm đúng với mọi $x\\in \\mathbb{{R}}$.",
        f"Tìm số giá trị nguyên của tham số ${{m}}$ thuộc khoảng $({t_1};{t_2})$ để bất phương trình ${f_am}<0$ nghiệm đúng với mọi $x\\in \\mathbb{{R}}$." ])
...
def aaa_pry_L10_C7_B2_15():
    ...
    noi_dung=random.choice([
        f"Tìm số giá trị nguyên của tham số ${{m}}$ thuộc khoảng $({t_1};{t_2})$ để bất phương trình ${f}\\ge 0$ nghiệm đúng với mọi $x\\in \\mathbb{{R}}$.",
        f"Tìm số giá trị nguyên của tham số ${{m}}$ thuộc khoảng $({t_1};{t_2})$ để bất phương trình ${f_am}\\le 0$ nghiệm đúng với mọi $x\\in \\mathbb{{R}}$." ])
...
def aaa_pry_L10_C7_B2_16():
    ...
    f"{latex(x**2)}-({latex(a*m+b)})x+{c}>0",
    f"{latex(-x**2)}+({latex(a*m+b)})x-{c}<0" ])
    noi_dung = (
    f"Số các giá trị nguyên của ${{m}}$ để bất phương trình ${bpt}$"
    f" nghiệm đúng với mọi $x\\in \\mathbb{{R}}$.")

    noi_dung_loigiai=(        
    f"${latex(x**2)}-({latex(a*m+b)})x+{c}>0$ có nghiệm đúng với mọi $x\\in \\mathbb{{R}}$\n\n"
